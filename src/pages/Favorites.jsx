    ...
    <div className="min-h-screen bg-bg-primary pt-28 pb-12">
      <div className="px-4 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="animate-fade-in-up">
          ...
          <p className="text-text-secondary mb-10">Movies you've loved</p>
        </div>
        {favorites.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            <div className="w-20 h-20 rounded-2xl bg-bg-secondary flex items-center justify-center text-red-400/50 mb-6">
              <Heart size={36} />
            </div>
            <p className="text-xl text-white mb-2">No favorites yet</p>
            <p className="text-text-muted max-w-md">
              Start exploring movies and tap the heart icon to save your favorites here.
            </p>
          </div>
        )}
      </div>
